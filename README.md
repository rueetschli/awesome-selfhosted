...
- [WorkPages](https://github.com/rueetschli/WorkPages) - Lightweight alternative to Jira and Confluence built for shared hosting, combining wiki and task management. (`[MIT](https://opensource.org/licenses/MIT)` `PHP`)
